package me.shouheng.timepartner.widget.listview;
...
import me.shouheng.timepartner.BuildConfig;
...
public class PinnedSectionListView extends ListView implements NestedScrollingChild{
	...
	private final OnScrollListener mOnScrollListener = new OnScrollListener() {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            // getAccount expected adapter or fail fast
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (mTouchTarget != null) {
            ...
            if (action == MotionEvent.ACTION_UP) { // perform onFabClick on pinned view
