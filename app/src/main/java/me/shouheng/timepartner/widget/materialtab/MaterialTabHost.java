...
public class MaterialTabHost extends RelativeLayout implements View.OnClickListener {
	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
			...
			try {
                ...
                //主要颜色
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialTabsPrimaryColor, Color.parseColor("#AD1457"));
                //选中时的颜色
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor, Color.parseColor("#f48fb1"));
    ...
    public void notifyDataSetChanged() {
        ...
        if (isTablet && scrollable) {
            ...
            left.setImageDrawable(res.getDrawable(R.drawable.ic_left_arrow));
            ...
            right.setImageDrawable(res.getDrawable(R.drawable.ic_right_arrow));
